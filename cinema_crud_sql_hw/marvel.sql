...
-- will delete all people with a name in the given list.

	DELETE FROM people WHERE name LIKE ('%Simpson');
-- will delete all people with a name including the string 'Simpson'.

	DELETE FROM movies WHERE year BETWEEN 2007 AND 2011;
-- will delete all movies with a year between 2007 and 2011
